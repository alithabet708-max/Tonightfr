...
const DeviceErrorBoundary = ({
  ...
  return (
    <SharedErrorBoundary
      ...
      description={
        sentLogs
          ? 'It looks like an error occurred while trying to use your app. This error has been reported. Check your app logs and deployment logs for details.'
          : 'It looks like an error occurred while trying to use your app. Check your app logs and deployment logs for details'
      }
    >
